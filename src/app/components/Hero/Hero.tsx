  ...
  return (
    <div className='bg-[#99C8FF]'>
      ...
      <div className='text-center mt-[2rem] md:mt-[1.5rem]'>
        ...
        <input placeholder='Enter your email' className=' my-6 md:mr-6  pl-5 font-sans py-4 w-[90%] md:w-[30%] bg-white transition-all duration-200 text-white rounded-2xl font-normal'/>
        
        <button  className=' py-4 w-[90%] md:w-[10%] bg-[#2B88D9] transition-all duration-200 text-white rounded-xl font-bold' onClick={()=>setshowJoinlist(true)}>
          Join waitlist
        </button>
        
      </div>
      <Joinwaitlist isVisible={showJoinlist} onClose={()=>setshowJoinlist(false)} />
